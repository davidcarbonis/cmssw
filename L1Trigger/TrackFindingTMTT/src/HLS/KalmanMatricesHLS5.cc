...
VectorX<5>::VectorX(const VectorX<5>& x, const MatrixK<5>& K, const VectorRes<5>& res) {
  ...
  typedef MatrixK<5>::TK         TK;
  _0 = x._0 + KFstateHLS<5>::TR(TK00_short(K._00) * res._0 + TK        (K._01) * res._1);
  _1 = x._1 + KFstateHLS<5>::TP(TK10_short(K._10) * res._0 + TK        (K._11) * res._1);
  _2 = x._2 + KFstateHLS<5>::TT(TK        (K._20) * res._0 + TK21_short(K._21) * res._1);
  _3 = x._3 + KFstateHLS<5>::TZ(TK        (K._30) * res._0 + TK31_short(K._31) * res._1);
#else
