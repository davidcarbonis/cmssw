...
class L1KalmanComb : public TrackFitGeneric{
	...
	L1fittedTrack fit(const L1track3D& l1track3D, const bool seedPair=false);
...
//        L1track3D singleStubClusterSeed ( const StubCluster* stub, const bool seedPair=false );
        L1fittedTrack fitClusteredTrack ( const L1track3D& l1track3D, const bool seedPair=false );
        //
    protected:
	/* Methods */
