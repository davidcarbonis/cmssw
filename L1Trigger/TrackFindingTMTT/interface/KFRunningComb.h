///=== This is the Kalman Combinatorial Filter for 4 & 5 running parameters track fit algorithm.
 
#ifndef __KFRUNNINGCOMB__
#define __KFRUNNINGCOMB__
...
class KFRunningComb : public L1KalmanComb {
 
    public:
        enum PAR_IDS  { RPHI, P, INV2R, T }; 
	enum MEAS_IDS { RPHI_S, P_S };
    public:
        KFRunningComb(const Settings* settings, const uint nPar, const string &fitterName );
        virtual ~KFRunningComb(){}
