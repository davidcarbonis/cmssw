...
class DigiConverter {
  public:
    ...
    DigiHTStub makeDigiHTStub( const TMTT::Stub& aHTStub, uint32_t aSectorId, int cBin, int aChiZ, int aChiPhi, bool mSel) const;
    DigiHTMiniStub makeDigiHTMiniStub( const TMTT::Stub& aHTMiniStub, uint32_t aSectorId, int8_t cBin, int8_t mBin) const;
