...
#include "Validation/SiPixelTrackClustersV/interface/SiPixelTrackClustersV.h"
...
SiPixelTrackClustersV::SiPixelTrackClustersV(const edm::ParameterSet& iConfig) :
...
void SiPixelTrackClustersV::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
DEFINE_FWK_MODULE(SiPixelTrackClustersV);
