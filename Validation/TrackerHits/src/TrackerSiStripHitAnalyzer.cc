#include "Validation/TrackerHits/interface/TrackerSiStripHitAnalyzer.h"
...
TrackerSiStripHitAnalyzer::TrackerSiStripHitAnalyzer(const edm::ParameterSet& ps)
...
void TrackerSiStripHitAnalyzer::bookHistograms(DQMStore::IBooker & ibooker,const edm::Run& run, const edm::EventSetup& es){
////// booking histograms
...
TrackerSiStripHitAnalyzer::~TrackerSiStripHitAnalyzer()
{
...
void TrackerSiStripHitAnalyzer::endJob(){
...
void TrackerSiStripHitAnalyzer::analyze(const edm::Event& e, const edm::EventSetup& c)
{
  ...
  if (!G4TrkContainer.isValid()) {
    edm::LogError("TrackerSiStripHitAnalyzer::analyze")
...
DEFINE_FWK_MODULE(TrackerSiStripHitAnalyzer);
