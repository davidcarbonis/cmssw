#ifndef TrackerSiStripHitAnalyzer_H
#define TrackerSiStripHitAnalyzer_H

/*
 * \file TrackerSiStripHitAnalyzer.h
 *
 * \author F. Cossutti
 *
*/
...
class TrackerSiStripHitAnalyzer: public DQMEDAnalyzer {
  
public:

/// Constructor
TrackerSiStripHitAnalyzer(const edm::ParameterSet& ps);

/// Destructor
~TrackerSiStripHitAnalyzer();
