...
#include "Validation/SiPixelHitsV/interface/SiPixelHitsV.h"
...
SiPixelHitsV::SiPixelHitsV(const edm::ParameterSet& iConfig) :
...
void SiPixelHitsV::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
DEFINE_FWK_MODULE(SiPixelHitsV);
